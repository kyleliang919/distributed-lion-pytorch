...
from async_trainer import AsyncSFTTrainer
...
class ScriptArguments:
    ...
    async_grad: Optional[bool] = field(default = False, metadata={"help": "whether to sync gradient between different workers"})
